        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 30px; margin-top: 10px;">
            ...
            <div class="glass-card" style="padding: 24px; min-height: 320px; display: flex; flex-direction: column; gap: 15px;">
                <h3 style="font-size: 15px; font-weight: 700; color: var(--text-primary); margin: 0; display: flex; align-items: center; gap: 8px;">
                    <i class="fa-solid fa-chart-line" style="color: var(--primary);"></i> Kanban İş Akışı Dağılımı
                </h3>
            ...
            <!-- Chart 2: Daily Created & Active trend -->
            <div class="glass-card" style="padding: 24px; min-height: 320px; display: flex; flex-direction: column; gap: 15px;">
                <h3 style="font-size: 15px; font-weight: 700; color: var(--text-primary); margin: 0; display: flex; align-items: center; gap: 8px;">
...
document.addEventListener("DOMContentLoaded", function() {
    // Kanban Chart
    const ctxKanban = document.getElementById('kanbanChart').getContext('2d');
    
    // Create soft gradient for kanban fill
    const gradKanban = ctxKanban.createLinearGradient(0, 0, 0, 200);
    gradKanban.addColorStop(0, 'rgba(20, 184, 166, 0.2)');
    gradKanban.addColorStop(1, 'rgba(20, 184, 166, 0.0)');
